...
<div class="card card-default">
        ...
        <div class="col-md-12">
            <p>Lipid test</p>        
                    <table class="table" id="lipid_table">
                        <thead>
                        </thead>
                        <tbody>
                            <tr id="lipid0">
                                <td width="25%">
                                    <select name="lab_type[]" class="form-control" >
                                        ...
                                        <option value="Lipids test">Lipid test</option>
                                ...
                                <td width="25%">
                                    <x-forms.textfield type="text" name="clinical_notes[]" placeholder="Clinical notes" required/>
                                </td>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <button id="add_row_lipid" class="btn btn-success pull-left btn-sm">+ Add Row</button>
                        <button id='delete_row_lipid' class="pull-right btn btn-danger btn-sm">- Delete Row</button>
                    </div>
                </div>
                </div>
                </div>
...
<script>
  ...
  $(document).ready(function(){
    let row_number = 1;
    $("#add_row_lipid").click(function(e){
      e.preventDefault();
      let new_row_number = row_number - 1;
      $('#lipid' + row_number).html($('#lipid' + new_row_number).html()).find('td:first-child');
      $('#lipid_table').append('<tr id="lipid' + (row_number + 1) + '"></tr>');
      row_number++;
    });

    $("#delete_row_lipid").click(function(e){
      e.preventDefault();
      if(row_number > 1){
        $("#lipid" + (row_number - 1)).html('');
        row_number--;
      }
    });
  }); 
