                ...
                <div class="navbar-header">
                    <div class="d-flex">
                        ...
                        <div class="navbar-brand-box">
                            ...
                            <span class="d-none d-xl-inline-block ms-1" style="color:#000;">HIMS INTERNAL MEDICINE</span>
                            @endcan

                            @can('is-lab')
                            <span class="d-none d-xl-inline-block ms-1" style="color:#000;">HIMS MEDICAL LAB</span>
                            @endcan
                            </a>
                        </div>
