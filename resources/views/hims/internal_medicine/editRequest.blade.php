...
<!-- Tab content -->
<x-forms.post action="{{ route('internal_medicine_admission.update') }}">
<div id="EditAdmission" class="tabcontent2">
    ...
    <div class="card card-default">
        ...
        <div class="card-footer">
            ...
            <a class="btn btn-secondary" role="button" href="{{route('internal_medicine_admission_request.list')}}">{{ __('Cancel') }}</a>
        </div>    
    </div>
